...
const AirportDetails = () => {
  ...
  return actualAirport.length != 0 ? (
    <div className="max-w-[1400px] m-auto w-full my-24">
      ...
      <h1 className="text-xl text-center mb-4 font-semibold text-black">
        Aeropuerto {slug.toUpperCase()}
      </h1>
      <h3 className="text-xl text-center mb-4 font-semibold text-black">
        Salidas
      </h3>
      <PanelesCard />
    </div>
