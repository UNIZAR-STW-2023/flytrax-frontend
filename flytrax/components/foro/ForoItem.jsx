...
const ForoItem = ({ data, iata }) => {
  ...
  return (
    <Link href={`/community/${iata}/posts/${data._id}`}>
      <div className= "border-b-[1px] border-neutral-800 p-5 cursor-pointer hover:bg-neutral-100 transition shadow-lg rounded-lg transform duration-500 hover:scale-110 relative my-2">
