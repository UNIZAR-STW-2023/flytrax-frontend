            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1  gap-6">
                ...
                {slice.map((airport, index) => (
                    <Link key={index} href={`/community/${airport.iata_code}`}> 
                        <div className= "border-b-[1px] border-neutral-800 p-5 cursor-pointer hover:bg-neutral-200 transition bg-neutral-100 text-black shadow-lg  hover:scale-110 rounded-lg transform duration-500 relative my-1">
